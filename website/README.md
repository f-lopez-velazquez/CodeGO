...
La carpeta `codego/` se publica en `https://zolvek.com.mx/codego/` y `https://zolvek.web.app/codego/`. El dominio canónico es zolvek.com.mx. El sitio corporativo conserva sus demás rutas.
